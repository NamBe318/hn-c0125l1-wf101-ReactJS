...
function ProgramingLanguageForm() {
  ...
  function validate() {
    ...
    if (!formData.studentName.trim())
      newErrors.studentName = "Trường tên học sinh không được để trống";
    if (!formData.email.trim())
      newErrors.email = "Trường email không được để trống";
    if (!formData.age) {
    ...
    if (formData.courses.length === 0) {
      newErrors.courses = "Vui lòng chọn ít nhất một khóa học";
    }
